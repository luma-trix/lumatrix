...
// Base path is environment-driven so one config serves every deploy target:
//   BASE_PATH unset      -> '/'          root hosting / custom domain (lumatrix.js.org)
//   BASE_PATH=/lumatrix/ -> '/lumatrix/' GitHub Pages project sub-path
// Always keep a leading and trailing slash.
    ...
    VitePWA({
      ...
      workbox: {
        ...
        runtimeCaching: [{
          ...
          handler: 'CacheFirst',
          options: { cacheName: 'nexa-fonts', expiration: { maxEntries: 10, maxAgeSeconds: 31536000 } }
        }]
      },
