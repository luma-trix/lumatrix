...
import {
  ...
  CaretLeft, CaretRight, ChartBar, ChatCircleDots, Check as CheckIcon, Checks, Clock, Coffee as CaffeineIcon, Copy as CopyIcon, Crop as CropIcon,
...
export const PhoneIncoming=modern(PhoneIncomingIcon), PhoneOutgoing=modern(PhoneOutgoingIcon), PhoneMissed=modern(PhoneXIcon), CallHistory=modern(ClockCounterClockwise), BellAlert=modern(BellRinging), Caffeine=modern(CaffeineIcon)
